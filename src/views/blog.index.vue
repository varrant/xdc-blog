  ...
  <div id="indexBox" class="indexBox animated fadeIn">
    <div class="index-content">
      <div class="head-wrap">
        ...
        <div id="headlines">
          <h1 :class="{'current': now==1}" class="text-center textItem">Hello <span class="blue">everybody</span></h1>
          <h1 :class="{'current': now==2}" class="text-center textItem">我是<span class="blue">XDC</span></h1>
